...
# Installation (Fork from Zabbix)
```
git clone https://github.com/ThomasMorrierBompoint/zabbix-docker.git
...
docker-compose run --rm directus install --email test@test.com --password Admin

Import demo data
docker exec -it directus_mysql bash
mysql -u directus -p directus < demo.sql
```
